...
public class FilesList {
	...
	public static FilePackage Core = new FilePackage("earlgrey.core", new String[]{"AdminApi", "CacheCore", "Communication", "ConnectionPool", "ConsoleCore", "ControllerCore", "Cronjob", "DatasourceManager",
			...
			"Session", "SO"});
	// Angular Files
	public static FilePackage Angular = new FilePackage("angular", new String[]{"Angular"});
	// Console Files
	...
	// LIST
	public static FilePackage [] List = { Core, Angular, Console, Annotations, Database, Def, Error, Gateway, Http, Interface, Policies, Security, Types, Utils }; 
}